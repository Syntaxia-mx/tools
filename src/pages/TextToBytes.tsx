...
export const TextToBytes = () => {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
        ...
        try {
            const bytesArray = new TextEncoder().encode(value);
            setOutput(bytesArray.join(", "));
        } catch {
        ...
        >
            ...
            <AnimatePresence>
                {showToast && (
                    ...
                    >
                        Bytes copiados al portapapeles ✅
                    </motion.div>
                )}
            </AnimatePresence>
            ...
            <p className="text-gray-400 mb-6 text-center max-w-3xl text-lg">
                Ingresa tu texto y obtén el arreglo de bytes correspondiente en tiempo real.
            </p>
                ...
                <div className="w-full md:w-1/2 flex flex-col gap-2">
                    <div className="flex gap-2 mb-2">
                        ...
                        <button
                            ...
                            className="p-2 rounded-full hover:bg-zinc-800 transition-colors"
                            aria-label="Cambiar a Bytes[] a Texto"
                        >
