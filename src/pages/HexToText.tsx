    ...
    return (
        ...
        >
            ...
            <p className="text-gray-400 mb-6 text-center max-w-3xl text-lg">
                Ingresa tu cadena hexadecimal separada por espacios y obtén el texto decodificado.
            </p>
                ...
                <div className="w-full md:w-1/2 flex flex-col gap-2">
                    <div className="flex gap-2 mb-2">
                        ...
                        <button
                            ...
                            className="p-2 rounded-full hover:bg-zinc-800 transition-colors"
                            aria-label="Cambiar a Texto a Hex"
                        >
                    ...
                    <textarea
                        ...
                        placeholder="Ingresa tu hexadecimal aquí..."
